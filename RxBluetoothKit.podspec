Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/OrzGeeker/RxBluetoothKit"
  ...
  s.source           = { :git => "https://github.com/OrzGeeker/RxBluetoothKit.git", :tag => s.version.to_s }
